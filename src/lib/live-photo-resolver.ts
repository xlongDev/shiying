...
/**
 * 实况照片探测复用 browser-pool 的共享浏览器（见 ./browser-pool）。
 * openNoteBrowser / closeNoteBrowser 已迁移为 browser-pool 的 acquirePage /
 * releasePage；以下 navigateNotePage 负责导航 + hydration 等待。
 */
