  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass my-3 mx-auto flex w-full max-w-6xl items-center justify-between rounded-full border border-white/10 px-5 py-3 shadow-lg shadow-black/10 sm:px-8"
      >
        {/* Logo */}
        <motion.div
